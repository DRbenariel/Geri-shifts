...
| `Schedule_Export` | wide-format export |
...
- `gerishifts-7ccae6b773f7.json` — service account private key. Never commit to git. Add to `.gitignore`. For GitHub Actions use the `GSHEETS_CREDENTIALS` secret.
